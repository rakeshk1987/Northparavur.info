...
function personaldataTmplt(person)
{
    ...
    <div class="personals">
        ...
        <br>
        <button id="${person.id}" onclick="descOpen(this.id)">More Info</button>
